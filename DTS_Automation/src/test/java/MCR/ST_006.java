...
public class ST_006 {
	public static void main(String[] args) throws Exception {
	    ...
	    mcr.findElement(By.cssSelector("#leftMenuContainer > table:nth-child(1) > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(1) > div:nth-child(1) > div:nth-child(1) > span:nth-child(1)")).click();
	    ...
	    networkElementsSel.selectByValue("EPSASCII");
	    mcr.findElement(By.id("file-1")).click();
	    StringSelection stringSelection = new StringSelection("D:\\Desktop\\EPSASCII-RatFix1.txt");
	  ...
	  // Release CTRL+V
	   ...
	   robot.keyRelease(KeyEvent.VK_ENTER);
	    ...
	    mcr.findElement(By.id("fileName")).sendKeys("EPSASCII-RatFix1.txt");
	...
	for (String temp : mcrWindow) {
		...
		mcr.switchTo().window(MCRW);
		 mcr.findElement(By.cssSelector("#leftMenuContainer > table:nth-child(1) > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(1) > div:nth-child(4) > div:nth-child(1)")).click();
		    ...
		    mcr.findElement(By.id("fileName")).sendKeys("EPSASCII-RatFix.txt");
		    mcr.findElement(By.cssSelector(".searchButtonCustom")).click();
